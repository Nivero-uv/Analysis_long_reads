#!/bin/bash
#SBATCH --job-name=sq_mseq
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --time=23:00:00
#SBATCH --mem-per-cpu=90G
#SBATCH --array=6,44,45,106,146,196,206,207,245,246,296,306,307,343,344,345,356,357,396,406,407,445
#SBATCH --qos=short
...
#mkdir sqanti3
dir="/home/nivero/Mas_Seq/analysis/sqanti3_masseq"
#find "/home/nivero/Mas_Seq/splitted" -name "*gtf" | sort > ${dir}/gtf_filenames.txt
...
# SQANTI classification of Mas-seq reads
...
python /home/nivero/SQANTI3/sqanti3_qc.py --skipORF -c "${illumina_sample}" --CAGE_peak "${TSSRef_file}" --polyA_motif_list ${PolyA_motif} --polyA_peak ${PolyA_file} --dir "${dir}/${sample}" -t 10 -n 5 --output "${sample}" ${splitted_gtf} ${ref_annotation} ${genome} 
